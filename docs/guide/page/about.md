...
2. 在`source\_data\`​文件夹下建立名为`about.yaml`​的文件，下方内容为模版，根据要求按需添加。
    ...
    tenyear:
      tips: "始终如一，不离不弃"
      title: "十年之约"
      start: 2023年4月20日    # 开始时间
      end: 2033年4月20日      # 结束时间
      text: "在这个十年中，我会用心感受生活的美好，用努力书写工作的篇章，用行动诠释人生的意义。这个进度条，不仅是数字的积累，更是我心中的期许和承诺。我相信，经过十年的坚持和努力，我会收获更多，成为一个更好的自己。"
...
::: tip
这里的echarts需要提前安装echarts插件，详情请到[文章统计页面配置](/guide/page/echart)查看
:::